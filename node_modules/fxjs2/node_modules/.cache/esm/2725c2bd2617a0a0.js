...
Connection.prototype.parse = function (query, more) {
  ...
  if (query.name.length > 63) {
    _261‍.g.console.error('Warning! Postgres only supports 63 characters for query names.')
    _261‍.g.console.error('You supplied', query.name, '(', query.name.length, ')')
    _261‍.g.console.error('This can cause conflicts and silent errors executing queries')
  }
