"main";_261‍.x([["MQL_DEBUG",()=>MQL_DEBUG],["PostgreSQL",()=>PostgreSQL],["MySQL",()=>MySQL]]);let is_string,is_function,flatten,cat,reduce,tap,go,pipe,map,filter,reject,pluck,uniq,each,index_by,group_by,uniqueBy,object,curry;_261‍.w("fxjs2",[["is_string",["is_string"],function(v){is_string=v}],["is_function",["is_function"],function(v){is_function=v}],["flatten",["flatten","cat"],function(v){flatten=cat=v}],["reduce",["reduce"],function(v){reduce=v}],["tap",["tap"],function(v){tap=v}],["go",["go"],function(v){go=v}],["pipe",["pipe"],function(v){pipe=v}],["map",["map"],function(v){map=v}],["filter",["filter"],function(v){filter=v}],["reject",["reject"],function(v){reject=v}],["pluck",["pluck"],function(v){pluck=v}],["uniq",["uniq"],function(v){uniq=v}],["each",["each"],function(v){each=v}],["index_by",["index_by"],function(v){index_by=v}],["group_by",["group_by"],function(v){group_by=v}],["uniqueBy",["uniqueBy"],function(v){uniqueBy=v}],["object",["object"],function(v){object=v}],["curry",["curry"],function(v){curry=v}]]);let pg;_261‍.w("pg",[["default",["pg"],function(v){pg=v}]]);let mysql;_261‍.w("mysql",[["default",["mysql"],function(v){mysql=v}]]);let plural,singular;_261‍.w("pluralize",[["plural",["plural"],function(v){plural=v}],["singular",["singular"],function(v){singular=v}]]);let load_ljoin;_261‍.w("./ljoin.js",[["default",["load_ljoin"],function(v){load_ljoin=v}]]);let dump;_261‍.w("dumper.js",[["dump",["dump"],function(v){dump=v}]]);
      ...
      return go(
        ...
        tap(function(query) {
          ...
          typeof MQL_DEBUG.LOG == 'function' ?
            MQL_DEBUG.LOG(query) : (MQL_DEBUG.LOG && _261‍.g.console.log(query));
        }),
        excute_query);
    }
